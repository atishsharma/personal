...
This is the codebase that powers my personal blog. It's a **GitHub Pages** site — plain HTML with minimal JavaScript for PWA support. :contentReference[oaicite:1]{index=1}
